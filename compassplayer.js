...
function IsRecinSourceCircle(pointxy,circle) {
...
oo = Math.pow((pointxy[0] - circle[0]),2) + Math.pow((pointxy[1] - circle[1]),2)-Math.pow(circle[3],2) ;
oo=  Math.pow((pointxy[0] - circle[0]),2) + Math.pow((pointxy[1] - circle[1]),2);
return oo 
